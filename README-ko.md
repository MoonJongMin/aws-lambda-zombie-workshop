...
23\. 주어진 가입 양식을 채워넣습니다. 단, 회원 가입 시 전화 번호에 대한 format validation이 진행됩니다. 따라서, 유효한 전화번호를 입력할 때는 미국 번호인 10자리 (예: 1882804331)를 넣으셔야 합니다. Lab2를 수행하지 않는다면 임의의 전화번호를 입력하시고 password 입력 후, 아래의 Select your Camp 가이드 부분으로 넘어가시고 Lab2를 수행한다면 아래를 참고해서 진행하시기 바랍니다.
